...
public class ProblemService {
     ...
     * @return
     */
    public Page<Problem> newlist(String labelid, int pageNo, int pageSize) {
     ...
     * @return
     */
    public Page<Problem> hotlist(String labelid, int pageNo, int pageSize) {
        Pageable pageable = PageRequest.of(pageNo - 1, pageSize);
     ...
     * @return
     */
    public Page<Problem> waitlist(String labelid, int pageNo, int pageSize) {
        Pageable pageable = PageRequest.of(pageNo - 1, pageSize);
