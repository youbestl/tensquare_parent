...
public class ProblemController {
    ...
    public Result newlist(@PathVariable String label,
        ...
        Page<Problem> pageResult = problemService.newlist(label, page, size);
    ...
    public Result hotlist(@PathVariable String label,
                          @PathVariable Integer page,
                          @PathVariable Integer size) {
        Page<Problem> pageResult = problemService.hotlist(label, page, size);
        return new Result(true, StatusCode.OK, "查询成功", new PageResult<>(pageResult.getTotalElements(), pageResult.getContent()));
    }
    ...
    public Result waitlist(@PathVariable String label,
                           @PathVariable Integer page,
                           @PathVariable Integer size) {
        Page<Problem> pageResult = problemService.waitlist(label, page, size);
        return new Result(true, StatusCode.OK, "查询成功", new PageResult<>(pageResult.getTotalElements(), pageResult.getContent()));
    }
