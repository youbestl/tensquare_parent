...
public class RecruitController {
    ...
    public Result recommend() {
        return new Result(true, StatusCode.OK, "查询成功", recruitService.findTop6ByStateOrderByCreatetime("2"));
    }
    ...
    public Result newlist() {
        return new Result(true, StatusCode.OK, "查询成功", recruitService.findTop6ByStateNotOrderByCreatetimeDesc("2"));
    }
